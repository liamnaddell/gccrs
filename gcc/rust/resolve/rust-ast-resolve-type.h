...
public:
  ...
  // 		   .lookup_lang_item_node (type_path.get_lang_item ())
  // 		   .value ();

  // auto resolver = Resolver::get ();
  // resolver->insert_resolved_type (type_path.get_node_id (), lang_item);
  ...
  //    upcast
  //    // to a Type. The altnernative is to split `go` into `go` and `go_inner`
  //    or
